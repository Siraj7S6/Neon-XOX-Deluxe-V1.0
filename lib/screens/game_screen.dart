          ...
          children: [
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                // FIXED: Calculate if this specific cell is part of the win
                final bool isWinning = state.winningLine != null && 
                                       state.winningLine!.contains(index);

                return GameCell(
                  value: state.board[index],
                  // FIXED: Changed from false to isWinning to enable neon cell glow
                  ...
                  builder: (context, child) {
                    return CustomPaint(
                      ...
                      painter: WinningLinePainter(
                        ...
                        // UPDATED: Use Neon Green for the high-quality line effect
